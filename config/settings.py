...
AFK_PANEL_CHANNEL_ID = 1504576187995914300    # Канал для рассмотрения заявок на афк
CHANNEL_FOR_CAPT = 1502673126268473355        # Канал для подачи заявки на капт
RATING_CHANNEL_ID = 1511031408456368149       # Канал для подачи заявки на повышение
ADMIN_RATING_CHANNEL_ID = 1511042942129803404 # Канал для рассмотрения заявки на повышение
...
HIGH_ROLE_ID = 1487937197142179880            # Роль High
DEP_ROLE_ID = 1487937119853744358             # Роль Dep
RECRUIT_ROLE_ID = 1482962712844828713         # Роль Recruit
